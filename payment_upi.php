    ...
    <div class="opppp">
        ...
        <div class="container">
            ...
            <div class="payment-methods">
                    ...
                    <h4>Total:  <span> ₹<?php echo $subtotal_gst ?></span></h4>
               <div class="payment2">
                    <form method="POST" enctype="multipart/form-data">
                        ...
                        <label><?php echo "ScreenShot Uploaded-"."Thankx For Payment"?></label><br>
                         <button type="submit" class="btn2"><a href="laststep.php?productid=<?php echo $encodedData ?>&img=<?php echo $itemimage ?>&m=<?php echo $subtotal_gst ?> ">Place Order</a></button> 
                        <?php
                    }
                    else{
                        ...
                        <input  type="file" placeholder="uplode image 1" name="itemimage" required accept="image/png,image/jpeg,image/jpg">
                        <input class="btn2"type="submit" value="Upload Screenshot" >
                        <?php
